dnl                wxWindows Library Licence, Version 3.1
dnl                ======================================
dnl
dnl  Copyright (c) 1998-2005 Julian Smart, Robert Roebling et al
dnl
dnl  Everyone is permitted to copy and distribute verbatim copies
dnl  of this licence document, but changing it is not allowed.
dnl
dnl                       WXWINDOWS LIBRARY LICENCE
dnl     TERMS AND CONDITIONS FOR COPYING, DISTRIBUTION AND MODIFICATION
dnl
dnl  This library is free software; you can redistribute it and/or modify it
dnl  under the terms of the GNU Library General Public Licence as published by
dnl  the Free Software Foundation; either version 2 of the Licence, or (at
dnl  your option) any later version.
dnl
dnl  This library is distributed in the hope that it will be useful, but
dnl  WITHOUT ANY WARRANTY; without even the implied warranty of
dnl  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU Library
dnl  General Public Licence for more details.
dnl
dnl  You should have received a copy of the GNU Library General Public Licence
dnl  along with this software, usually in a file named COPYING.LIB.  If not,
dnl  write to the Free Software Foundation, Inc., 51 Franklin Street, Fifth Floor,
dnl  Boston, MA 02110-1301 USA.
dnl
dnl  EXCEPTION NOTICE
dnl
dnl  1. As a special exception, the copyright holders of this library give
dnl  permission for additional uses of the text contained in this release of
dnl  the library as licenced under the wxWindows Library Licence, applying
dnl  either version 3.1 of the Licence, or (at your option) any later version of
dnl  the Licence as published by the copyright holders of version
dnl  3.1 of the Licence document.
dnl
dnl  2. The exception is that you may use, copy, link, modify and distribute
dnl  under your own terms, binary object code versions of works based
dnl  on the Library.
dnl
dnl  3. If you copy code from files distributed under the terms of the GNU
dnl  General Public Licence or the GNU Library General Public Licence into a
dnl  copy of this library, as this licence permits, the exception does not
dnl  apply to the code that you add in this way.  To avoid misleading anyone as
dnl  to the status of such modified files, you must delete this exception
dnl  notice from such code and/or adjust the licensing conditions notice
dnl  accordingly.
dnl
dnl  4. If you write modifications of your own for this library, it is your
dnl  choice whether to permit this exception to apply to your modifications. 
dnl  If you do not wish that, you must delete the exception notice from such
dnl  code and/or adjust the licensing conditions notice accordingly.
