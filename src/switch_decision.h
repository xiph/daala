...
void od_switch_start_frame(od_switch_decision_state *st, const unsigned char *img, int stride);
...
void od_switch_process_superblock(od_switch_decision_state *st, const unsigned char *img, int stride, int blocksize[4][4]);
